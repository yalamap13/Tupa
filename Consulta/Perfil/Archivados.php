    ...
    <div class="col-xs-12">
      <div class="card border-default mb-12">
        <div class="card-header bg-transparent border-default">
              <ul class="breadcrumb">
                    <li>
                         <h5 style="font-weight: 700;"> EXPEDIENTES ARCHIVADOS
                        </h5>
                    </li>
                </ul>
        </div>
...
<div class="modal fade" id="AbrirModalArchivo" tabindex="-1" role="dialog" aria-hidden="true" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
        	<form class="form-horizontal" action="Funcionalidad/Expediente/GuardarArchivo.php" method="post" id="FormularioArchivo" name="FormularioArchivo" enctype="multipart/form-data">
            <div class="modal-header text-center color-modal">
...
<script type="text/javascript" src="Intermediario/Archivados.js"></script>