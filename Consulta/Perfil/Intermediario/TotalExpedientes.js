...
$(document).ready(function() {
	...
	tabla = $("#LlenarTabla").DataTable({
		"ajax": "Funcionalidad/Expediente/ListarTotalExpedientes.php",
        "order": [ 1, "desc" ],
        pageLength: 9,
        dom: 'fBtip',
        responsive: true,
...
/*
function EstadoPorLlegar(Id = null) {
                  $.ajax({
                        url: 'Funcionalidad/Expediente/EstadoPorLlegar.php',
                        type: 'post',
                        ...
                        success:function(response) {
                              if(response.success == true) {                                          
                                   ...
                                   sweetAlert("Error al Crear Derivaci®Æn o Datos Invalidos!", "Error", "warning");
                              }}
                  });
}
*/
                  ...
                  success:function(response) {
                        ...
                        $("#FormularioDerivar").unbind('submit').bind('submit', function() {
                                    ...
                                    if(response.success == true) {
                                          ...
                                          tabla.ajax.reload(null, false);
                                          sweetAlert("Actualizaci√≥n!", "Actualizo Correctamente...", "success")                                                           
                                    } else {
