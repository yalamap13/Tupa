    ...
    <div class="col-xs-12">
      <div class="card border-default mb-3">
        <div class="card-header bg-transparent border-default">
              <ul class="breadcrumb">
                    <li>
                         <h5 style="font-weight: 700;"><label style="color:#2e6da4;"></label>UNIDAD ORGANICA
...
<div class="modal fade" id="AbrirModal" tabindex="-1" role="dialog" aria-hidden="true" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
        	<form class="form-horizontal" action="Funcionalidad/UnidadOrganica/Grabar.php" method="post" id="Formulario" name="Formulario">
            ...
            <div class="modal-body mx-3" style="display: flow-root;">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                    ...
                    <input type="text" id="TransferirIniciales" name="TransferirIniciales" maxlength="15" placeholder="Iniciales" class="form-control validate"> 
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <label data-error="wrong" class="label-modal label-top-modal" data-success="right">Denominación</label>
                    <input type="text" id="TransferirDenominacion" name="TransferirDenominacion" maxlength="100" placeholder="Denominación" class="form-control validate"> 
                </div>
            </div> 
...
<script type="text/javascript" src="Intermediario/UnidadOrganica.js"></script>