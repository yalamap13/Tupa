                                ...
                                <div class="md-form mb-5 col-lg-12" style="border:1px solid #ccc;padding:5px;display:flex;">
                                    <div class="md-form mb-5 col-lg-12">
                                        <div style="display:flex;">
                                            ...
                                            <input class="form-control validate" style="border:0px;" id="TransferirDependencia" name="TransferirDependencia" value="<?php echo ''.$Parametro6.''; ?>" placeholder="Oficina" required>
                                            </input>
                                        </div>
                                        <div style="display:flex;">
