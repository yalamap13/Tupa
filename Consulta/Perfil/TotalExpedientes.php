        ...
        <div class="modal-content">
            ...
            <div class="modal-body mx-3" style="display: flow-root;">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    ...
                    <div class="col-xs-6 col-sm-9 col-md-9" id="divPatrocinado" name="divPatrocinado">
                    <label data-error="wrong" class="label-modal label-top-modal" data-success="right">Patrocinado</label>
                        <select class="form-control validate" id="TransferirIdPatrocinado" name="TransferirIdPatrocinado">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12" id="divProcedimiento" name="divProcedimiento">
                    <label data-error="wrong" class="label-modal label-top-modal" data-success="right">Procedimiento</label>
                        <select class="form-control validate" id="TransferirIdProcedimiento" onclick="FiltrarRequisito();" name="TransferirIdProcedimiento">
...
<script type="text/javascript" src="Intermediario/TotalExpedientes.js"></script>