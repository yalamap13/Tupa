    ...
    <div class="col-xs-12">
      <div class="card border-default mb-3">
        <div class="card-header bg-transparent border-default">
              <ul class="breadcrumb">
                    <li>
                         <h5 style="font-weight: 700;"><label>MANTENIMIENTO DE AREA </label>
...
<div class="modal fade" id="AbrirModal" tabindex="-1" role="dialog" aria-hidden="true" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
        	<form class="form-horizontal" action="Funcionalidad/Area/Grabar.php" method="post" id="Formulario" name="Formulario">
            ...
            <div class="modal-body mx-3">
                <div class="md-form mb-5">
                    <label data-error="wrong" class="label-modal label-top-modal" data-success="right" >Área Laboral</label>
                    <input type="text" id="TransferirNombre" name="TransferirNombre" placeholder="Área Laboral" class="form-control validate" required> 
                </div>
            </div>
...
<script type="text/javascript" src="Intermediario/Area.js"></script>