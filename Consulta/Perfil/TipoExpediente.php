    ...
    <div class="col-xs-12" style="margin-top:70px;">
      <div class="card border-default mb-3">
        <div class="card-header bg-transparent border-default">
              <ul class="breadcrumb">
                    <li>
                         <h5 style="font-weight: 700;"><label style="color:#2e6da4;">TIPO</label> - EXPEDIENTE
...
<div class="modal fade" id="AbrirModal" tabindex="-1" role="dialog" aria-hidden="true" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
        	<form class="form-horizontal" action="Funcionalidad/TipoExpediente/Grabar.php" method="post" id="Formulario" name="Formulario">
...
<script type="text/javascript" src="Intermediario/TipoExpediente.js"></script>